...
CREATE TABLE GioHang (
    ...
    MaKH INT,           -- Khách hàng nào
    MaSP INT,           -- Sản phẩm nào
    SoLuong INT CHECK (SoLuong > 0), -- Số lượng sản phẩm trong giỏ
...
--INSERT INTO SanPham (TenSP, MoTa, Gia, Anh, MaDM)
--VALUES 
--(N'Hamburger', N'Hamburger bò phô mai', 45000, 'images/hamburger.jpg', 1),
--(N'Pizza phô mai', N'Pizza Ý nhiều phô mai', 120000, 'images/pizza.jpg', 1),
--(N'Coca Cola', N'Nước ngọt có gas', 15000, 'images/coca.jpg', 2),
--(N'Trà sữa trân châu', N'Trà sữa truyền thống', 35000, 'images/trasua.jpg', 2),
--(N'Bánh Flan', N'Bánh flan caramel mềm mịn', 20000, 'images/flan.jpg', 3);
...
INSERT INTO NhanVien (HoTen, Email, SDT, VaiTro, MatKhau)
VALUES 
(N'Nguyễn Văn Quản', 'quanly@example.com', '0911222333', N'Quản lý','123456'),
(N'Phạm Thị Giao', 'giaohang@example.com', '0922333444', N'Giao hàng','123456'),
(N'Lê Văn Admin', 'admin@example.com', '0933444555', N'Admin','123456');
